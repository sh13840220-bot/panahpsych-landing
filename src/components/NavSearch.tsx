...
export const SEARCH_INDEX: SearchItem[] = [
...

  {
    ...
    description:
      "ارزیابی شدت علائم اضطراب در ۳ بعد بدنی، ذهنی و هراس",
    category: "آزمون‌ها",
    path: "/assessments/bai",
    tags: [
      "اضطراب بک",
      "بک",
      "bai",
...

  {
    ...
    description:
      "ارزیابی جامع و ۹ بعدی نشانه‌های بالینی و آسیب‌شناسی روانی",
    category: "آزمون‌ها",
    path: "/assessments/scl-90",
    tags: [
      "اس سی ال",
      "scl",
      "scl90",
  ...
  {
    id: "cfi",
    title: "انعطاف‌پذیری شناختی (CFI)",
    description:
      "سنجش بازسازی شناختی، خلق راهکارهای جایگزین و کنترل موقعیت‌های دشوار",
    category: "آزمون‌ها",
    path: "/assessments/cfi",
    tags: [
      "انعطاف پذیری",
      "انعطاف پذیری شناختی",
      "سی اف آی",
  ...
  {
    id: "bar-on",
    title: "هوش هیجانی بار-آن (Bar-On EQ-i)",
    description:
      "سنجش جامع ۱۵ مهارت هوش هیجانی در ۵ حیطه درون‌فردی، بین‌فردی، سازگاری و مدیریت استرس",
    category: "آزمون‌ها",
    path: "/assessments/bar-on",
    tags: [
      "هوش هیجانی",
      "هوش عاطفی",
      "بار آن",
  ...
  {
    id: "neo-240",
    title: "آزمون NEO (پرسشنامه جامع ۲۴۰ سؤالی شخصیت)",
    description:
      "ارزیابی تخصصی ۵ عامل بزرگ شخصیت و ۳۰ ویژگی و خرده‌مقیاس رفتاری (NEO PI-R)",
    category: "آزمون‌ها",
    path: "/assessments/neo",
    tags: [
      "نئو",
      "آزمون neo",
      "تست neo",
